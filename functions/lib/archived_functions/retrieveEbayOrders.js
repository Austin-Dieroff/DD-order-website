...
exports.retrieveEbayOrders = void 0;
const admin = require("firebase-admin");
const functions = require("firebase-functions");
// import { EbayAPI } from "../../../../../../../../Development/ebay-api/lib";
const ebay_api_simple_1 = require("ebay-api-simple");
const helpers_1 = require("../helpers");
/**
 * Run on a schedule to retrieve Ebay Orders
...
exports.retrieveEbayOrders = functions.pubsub
    .schedule("0 7-18 * * 1-5")
    .timeZone("America/New_York")
    .onRun(async () => {
    console.log("retrieveEbayOrders function running...");
    try {
        ...
        if (!orderExists) {
            ...
            const newOrder = {
                ...
                customerDetails: {
                    vatBranchID: "230",
                    termsCode: "   EBay",
                    shipViaCode: getShipViaCode(order.fulfillmentStartInstructions)
                },
                billToContact: {
...
//
function getShipViaCode(fulfillmentStartInstructions) {
    let shipViaCode = "Not Set";
    const shippingServiceCode = fulfillmentStartInstructions.shippingStep.shippingServiceCode;
    console.log("TCL: getShipViaCode -> shippingServiceCode", shippingServiceCode);
    if (shippingServiceCode === "UPSGround")
        shipViaCode = " GR.UPSPPA";
    else if (shippingServiceCode === "UPS3rdDay")
        shipViaCode = " 3D.PP&A";
    else if (shippingServiceCode === "UPS2ndDay")
        shipViaCode = " 2D.PP&A";
    else if (shippingServiceCode === "UPSNextDay")
        shipViaCode = " R.UPS.PPA";
    else if (shippingServiceCode === "UPSNextDayAir")
        shipViaCode = " R.UPS.PPA";
    return shipViaCode;
}
//# sourceMappingURL=retrieveEbayOrders.js.map